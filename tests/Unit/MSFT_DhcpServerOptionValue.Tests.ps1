...
$script:dscResourceName = 'MSFT_DhcpServerOptionValue'
...
try
{
    InModuleScope $script:dscResourceName {
        ...
        Describe 'xDhcpServer\Get-TargetResource' {
            ...
            Mock Get-DhcpServerv4OptionValue -MockWith $GetFakeDhcpServerv4OptionValue
            ...
            It 'Returns all correct values' {
                ...
                Mock Get-DhcpServerv4OptionValue -MockWith $getFakeDhcpServerv4OptionValueDifferentValue
