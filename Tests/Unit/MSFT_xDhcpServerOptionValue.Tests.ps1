...
$TestEnvironment = Initialize-TestEnvironment `
    ...
    -DSCResourceName 'MSFT_xDhcpServerOptionValue' `
    -TestType Unit
...
try
{
    ...
    InModuleScope 'MSFT_xDhcpServerOptionValue' {
       
        $optionId      = 67
        $optionValue   = @('test Value')
        $vendorClass   = ''
        $userClass     = ''
        $addressFamily = 'IPv4'
        $ensure        = 'Present'
        ...
        Describe 'xDhcpServer\Test-TargetResource' {
            ...
            It 'Returns a "System.Boolean" object type' {
                ...
                $result = Test-TargetResource @testParams -Ensure 'Present' -OptionValue $optionValue
            ...
            It 'Returns $false when the option exists and Ensure = Absent ' {
                ...
                $result = Test-TargetResource @testParams -Ensure 'Absent' -OptionValue $optionValue
                $result | Should Be $false
            }
        }
        ...
        Describe 'xDhcpServer\Set-TargetResource' {
            ...
            It 'Should call "Set-DhcpServerv4Optionvalue" when "Ensure" = "Present" and definition does not exist' {
                ...
                Set-TargetResource @testParams -Ensure 'Present' -OptionValue $optionValue
            ...
            It 'Should call "Remove-DhcpServerv4OptionValue" when "Ensure" = "Absent" and Definition does exist' {
                ...
                Set-TargetResource @testParams -Ensure 'Absent' -OptionValue $optionValue
